...
namespace Pikmin
{
    public class PikminClimbState : BaseState<PikminStateManager.PikminState>
    {
        ...
        public override PikminStateManager.PikminState GetNextState() 
        {
            ...
            bool floorFront = CheckSurfaceHit(stateManager.transform.position, stateManager.transform.up, sphereCastRadius, detectionLength, stateManager.floorLayer, out surfaceHit, out floorLookAngle);
            ...
            {
                float wallLookAngle;
                bool wallFront = CheckSurfaceHit(stateManager.transform.position, stateManager.transform.up, sphereCastRadius, detectionLength, stateManager.wallLayer, out surfaceHit, out wallLookAngle);
