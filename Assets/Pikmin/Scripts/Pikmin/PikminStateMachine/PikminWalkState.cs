...
namespace Pikmin
{
    public class PikminWalkState : BaseState<PikminStateManager.PikminState>
    {
        ...
        public override PikminStateManager.PikminState GetNextState() 
        {
            ...
            float wallLookAngle;
            bool wallFront = CheckSurfaceHit(stateManager.transform.position, stateManager.transform.forward, sphereCastRadius, detectionLength, stateManager.wallLayer, out frontWallHit, out wallLookAngle);
